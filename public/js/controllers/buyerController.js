angular.module('buyerController', ['allProjectsFactory', 'checkPwFactory', 'getSwatchesFactory'])

  .controller('buyerCtrl', buyerCtrl)

  buyerCtrl.$inject = ['$http', 'allProjects', 'checkPw', 'allSwatches'];
  function buyerCtrl($http, allProjects, checkPw, allSwatches){
    var self = this;
